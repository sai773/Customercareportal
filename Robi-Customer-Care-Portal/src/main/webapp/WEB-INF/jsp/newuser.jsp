            ...
            <div id="login-row" class="row justify-content-center align-items-center" >
                <div id="login-column" class="col-md-6">
                    ...
                    <div id="login-box" class="col-md-12">
                       <form name="loginForm" method="post" action="adminNewUser">
                           
                            <br>
                            <h1 style="font-size:18px;font-weight:bold;margin-left:40%;">Add New User</h1>
                            <div id='message' style="color: #FF0000;margin-left:42%;margin-top:5px;"></div>
                       		 <div id="loginMsg" style="color: #FF0000;margin-left:34%">${errorMessage}</div>
                           
                            <div class="form-group">
                                <input type="text" name="username" id="username" autocomplete="off" placeholder="Username" class="form-control short" >
                         	 </div>
                          ...
                          <script type="text/javascript"> 
                            ...
                            <div class="form-group">
                                  ...
                                  <input type="submit"  name="Add" value="Add User"   style="margin-right:30px;margin-top:3%"  class="btn btn-primary btn-lg text-white float-right gradient" value="Login" >
                            </div>
