...
<script src="js/disableFunctionalKeys.js" type="text/javascript"></script>
                    ...
                    <div id="login-box" class="col-md-12">
                       <form name="loginForm" method="post" action="adminLoginForm">
                            ...
                            <div class="form-group" style="margin-top:15%">
                               <a href="#"  style="margin-left:29px;margin-top:4%" class="text-info" onclick="fsa()"> Forgot Your password</a>
                               <script> function fsa(){
   	 										alert("Please contact to admin for details");
										}
								</script>
								 <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="submit" name="Login" style="margin-right:30px;margin-top:-10%"  class="btn btn-primary btn-lg text-white float-right gradient" value="Login" >
...
if ( window.history.replaceState ) {
  window.history.replaceState( null," Robi", "/RobiCC/login" );
}
</script>
